...
| **补充约束**   | 1、对于95%的设备，应在3.0秒内完成页面切换。<br/>2、对于90%的翻页点击，应在2.0秒内完成新页面的加载。<br />3、应以某种合适的顺序对教育资源进行排序。<br />4、在资源推荐首页应该采取“个性化推荐”。|
...
| **基本事件流** | （用户） 1、用户或管理员点击相应教育资源的“下载”按钮。<br/>（系统） 2、系统将下载事件发送给用户浏览器，如果是用户下载教育资源，更新教育资源下载量、上传用户积分等统计数据，将本次下载添加至当前登录的用户的下载历史。 |
| **扩展事件流** | 无                                                           |
| **补充约束**   | 无                                                           |
